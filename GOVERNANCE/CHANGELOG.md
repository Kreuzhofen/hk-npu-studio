...
### Hinzugefügt
* **Backend Discovery & Environment Detection (P-061):** Einführung des `BackendDiscoveryService` und der Datenklasse `DiscoveryResult` zur automatischen OS-, Python-, ONNX- und Qualcomm QNN SDK-Erkennung. Erweiterung des `BackendManager` und Einbau einer System-Umgebungskarte im Model Manager sowie erweiterter Statusleistenanzeigen in AI Generate.
