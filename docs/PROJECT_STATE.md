...
* **Sprint P-061 & P-061.1 & P-061.2 & P-061.3 (Backend Discovery, UX Polish, Scrollable Inspector & Table Columns Polish):**
  ...
  * **Spaltenbreiten-Politur:** Anpassung der Treeview-Spaltenbreiten im Model Manager (Status-Spalte auf 180px vergrößert, Backend-Spalte auf 160px optimiert). Längere Texte wie "Available for Download" werden nun vollständig lesbar dargestellt.
